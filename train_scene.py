...
def prepare_output_and_logger(args):    
    if not args.model_path:
        ...
        last_two_parts = os.path.join(os.path.basename(os.path.dirname(args.source_path)), os.path.basename(args.source_path))
        args.model_path = os.path.join("./output/", last_two_parts, unique_str[0:10])
