...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, uid, cx = None, cy = None, features = None, patch_features = None, masks = None, mask_scales = None,
        ...
        self.original_patch_features = patch_features

        self.original_masks = masks
        self.mask_scales = mask_scales
        self.feature_width = self.original_image.shape[2]
        self.feature_height = self.original_image.shape[1]
